    ...
    <el-dialog title="设置人数" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="人数:" :label-width="formLabelWidth" width="60%">
          <el-input v-model="form.number" autocomplete="off" type="number" style="width: 40%"></el-input>
        </el-form-item>
      </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            onEdit(item) {
                ...
                this.form.number = item.crowdAmount
            },

            onSubmit() {
                this.$axios({
                    url: '/system/organization/crowdAmountSet',
                    method: 'POST',
                    data: {
                        organization: {
                            orgId: state.govId,
                            crowdAmount: this.form.number
                        }
                    }
                }).then(res => {
